### POWER CURVES FOR ACTUAL SAMPLE
...
samples <- 23564+40138
ratio <- 23564/40138 # ratio of cases to controls
...
a <- ggplot(filter(results, samples==63702), aes(x=or, y=100*power, color=as.factor(maf0))) +
  geom_line(size=1.5) +
  theme_bw() +
